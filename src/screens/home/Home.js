...
class Home extends Component {
  ...
  /** Loading all the restaurant methods with details into the state variables */
  loadAllRestaurants() {
    getRestaurant()
      .then(response => {
        this.setState({
  ...
  /** Loading all the restaurant details methods for the given name into the state variables */
  ...
  /** To navigate customer to the respective restuarant when clicked on the restaurant */
  ...
  render() {
    ...
    return (
      <div>
        {/** Header component Continue here as well*/}
        <Header
          searchVal={searchVal}
