...
class Checkout extends Component {
  ...
  /**To set the state value when a single payment method is selected */
  ...
  /** To set value into a single state variable */
  ...
  render() {
    ...
    return (
      <div>
        ...
        {/** Starting of Checkout section Feature  */}
        <div className="checkout-container">
          {/** Starting of Delivery and Payment feature */}
          ...
          {/** Ending of Delivery and Order summary feature */}
        </div>
        {/** Ending of Checkout feature*/}
      </div>
    );
  }
}
