...
class LoginModal extends Component {
  ...
  /** To switch between different tabs in login modal */
  ...
  /** To set value into a particular state variable */
  ...
  /** Handler to sign up customer if all the required steps are followed and in required/proper format */
